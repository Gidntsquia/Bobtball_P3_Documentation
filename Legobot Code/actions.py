...
def get_crates():
    ...
    f.lfollow_right_until_left_senses_black_smooth_amount(500, c.BASE_LM_POWER, c.BASE_RM_POWER, int (.5 * c.BASE_LM_POWER), int (.5 * c.BASE_RM_POWER), 0, 0, False)
    f.lfollow_right_until_left_senses_black_smooth_amount(500, c.BASE_LM_POWER, c.BASE_RM_POWER, int (.7 * c.BASE_LM_POWER), int (.7 * c.BASE_RM_POWER), c.BASE_LM_POWER, c.BASE_RM_POWER, False)
    f.lfollow_right_until_left_senses_black_smooth_amount(10000, c.BASE_LM_POWER, c.BASE_RM_POWER, int (.9 * c.BASE_LM_POWER), int (.9 * c.BASE_RM_POWER), c.BASE_LM_POWER, c.BASE_RM_POWER, False)
    ...
    f.right_point_turn_until_third_senses_white(10000, 0, 0, False)
    f.right_point_turn_until_third_senses_black(10000, c.BASE_LM_POWER, -1 * c.BASE_RM_POWER)
